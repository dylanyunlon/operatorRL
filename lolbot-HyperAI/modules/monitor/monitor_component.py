...
# Claude26: Apollo-style separation — delegate to sub-modules
from modules.monitor.alert.alert_manager import AlertSeverity, AlertRecord, AlertManager
...
# Claude26: AlertSeverity, AlertRecord, AlertManager moved to modules/monitor/alert/alert_manager.py

# Claude26: ResourceTracker moved to modules/monitor/resource/resource_tracker.py

# Claude26: ComponentHealthEntry, ComponentHealthTracker moved to modules/monitor/resource/health_tracker.py
