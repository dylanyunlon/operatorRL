...
Architecture Pattern:
  ...
  遵循该模式实现 ObjectiveControlProfiler,
  让 operatorRL 可以Profile opponent objective control habits,
...
MODULE_ID = "M917"
MODULE_NAME = "ObjectiveControlProfiler"
...
class ObjectiveControlProfiler:
    """
    Profile opponent objective control habits — dragon priority, herald usage, baron timing patterns
    ...
    def __init__(self, connector=None, config: Optional[Dict[str, Any]] = None):
        ...
        logger.info("ObjectiveControlProfiler initialized (deps=['M906', 'M908', 'M916'])")
    ...
    async def analyze(self, input_data: Dict[str, Any]) -> AnalysisResult:
        ...
        try:
            ...
            logger.error("ObjectiveControlProfiler analysis error: %s", exc)
    ...
    async def reset(self) -> None:
        ...
        self._process_count = 0
        self._error_count = 0
        logger.info("ObjectiveControlProfiler reset")

    def __repr__(self) -> str:
        return f"ObjectiveControlProfiler(state={self._state.value}, processed={self._process_count})"


__all__ = [
    "ObjectiveControlProfiler",
    "AnalysisResult",
    "AnalysisState",
    "ConfidenceLevel",
    "AnalysisCache",
