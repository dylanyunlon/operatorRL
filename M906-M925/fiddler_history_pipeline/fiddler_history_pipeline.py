...
Fiddler MCP integration for capturing LCU history API traffic — correlate network captures with parsed history
...
Architecture Pattern:
  ...
  遵循该模式实现 FiddlerHistoryPipeline,
  让 operatorRL 可以Fiddler MCP integration for capturing LCU history API traffic,
...
MODULE_ID = "M919"
MODULE_NAME = "FiddlerHistoryPipeline"
...
class FiddlerHistoryPipeline:
    ...
    def __init__(self, connector=None, config: Optional[Dict[str, Any]] = None):
        ...
        logger.info("FiddlerHistoryPipeline initialized (deps=['M906', 'M907'])")
    ...
    async def analyze(self, input_data: Dict[str, Any]) -> AnalysisResult:
        ...
        try:
            ...
            logger.error("FiddlerHistoryPipeline analysis error: %s", exc)
    ...
    async def reset(self) -> None:
        ...
        self._process_count = 0
        self._error_count = 0
        logger.info("FiddlerHistoryPipeline reset")

    def __repr__(self) -> str:
        return f"FiddlerHistoryPipeline(state={self._state.value}, processed={self._process_count})"


__all__ = [
    "FiddlerHistoryPipeline",
    "AnalysisResult",
    "AnalysisState",
    "ConfidenceLevel",
    "AnalysisCache",
