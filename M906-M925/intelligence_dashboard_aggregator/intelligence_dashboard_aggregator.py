...
Aggregate all M906-M925 intelligence into unified dashboard — JSON/HTML reports, voice briefing feed
...
Architecture Pattern:
  ...
  遵循该模式实现 IntelligenceDashboardAggregator,
  让 operatorRL 可以Aggregate all M906-M925 intelligence into unified dashboard,
  并能与 M906 SeraphineConnectorBridge 集成。

Dependencies: M906, M910, M914, M918, M922
# Depends on: M906
# Depends on: M910
# Depends on: M914
# Depends on: M918
...
MODULE_ID = "M925"
MODULE_NAME = "IntelligenceDashboardAggregator"
...
class IntelligenceDashboardAggregator:
    """
    Aggregate all M906-M925 intelligence into unified dashboard — JSON/HTML reports, voice briefing feed
    ...
    def __init__(self, connector=None, config: Optional[Dict[str, Any]] = None):
        ...
        logger.info("IntelligenceDashboardAggregator initialized (deps=['M906', 'M910', 'M914', 'M918', 'M922'])")
    ...
    async def analyze(self, input_data: Dict[str, Any]) -> AnalysisResult:
        ...
        try:
            ...
            logger.error("IntelligenceDashboardAggregator analysis error: %s", exc)
    ...
    async def reset(self) -> None:
        ...
        self._process_count = 0
        self._error_count = 0
        logger.info("IntelligenceDashboardAggregator reset")

    def __repr__(self) -> str:
        return f"IntelligenceDashboardAggregator(state={self._state.value}, processed={self._process_count})"


__all__ = [
    "IntelligenceDashboardAggregator",
    "AnalysisResult",
    "AnalysisState",
    "ConfidenceLevel",
    "AnalysisCache",
